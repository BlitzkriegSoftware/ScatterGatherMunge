...
namespace StuartWilliams.ScatterGatherMunge.Lib.Models
{
    ...
    public class RabbitMqEngineConfiguration
    {
        ...
        public void SetProperty(string key, string value)
        {
            ...
            {
                case "rabbitmq-host": this.Host = value; break;
                case "rabbitmq-messagedeliverymode": this.MessageDeliveryMode = Convert.ToByte(value); break;
                case "rabbitmq-messageexpiration": this.MessageExpiration = value; break;
                case "rabbitmq-messagepersistent": this.MessagePersistent = Convert.ToBoolean(value); break;
                case "rabbitmq-password": this.Password = value; break;
                case "rabbitmq-port": this.Port = Convert.ToInt32(value); break;
                case "rabbitmq-queueautodelete": this.QueueAutoDelete = Convert.ToBoolean(value); break;
                case "rabbitmq-queuedurable": this.QueueDurable = Convert.ToBoolean(value); break;
                case "rabbitmq-queueexclusive": this.QueueExclusive = Convert.ToBoolean(value); break;
                case "rabbitmq-username": this.Username = value; break;
            }
        }
